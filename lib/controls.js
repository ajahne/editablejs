...
var controls = function () {
  ...
  */
  var setPositionBasedOnSelectionBox = function setPositionBasedOnSelectionBox(selectionBox) {
    var selectionBoxCenterX = selectionBox.getX() + selectionBox.getWidth() / 2;
    var x = selectionBoxCenterX - getWidth() / 2;
    var y = selectionBox.getY() - getHeight();
    setPosition(x, y);
  };
  ...
  return {
    ...
    getWidth: getWidth,
    getHeight: getHeight,
    setPositionBasedOnSelectionBox: setPositionBasedOnSelectionBox,
    isVisible: isVisible
  };
}();